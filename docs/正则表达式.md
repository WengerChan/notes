...
| 匹配非次字符集<sup id="a4">[4](#f4) | `[^xyz]` | `[^xyz]` | `[^xyz]` | `[^xyz]` | `[^xyz]` |
...
| 匹配非空白字符(=`[^\f\n\r\t\v]`) | `\S` | N/A | N/A | `\S` | `\S` |
| 匹配空白字符<sup id="a5">[5](#f5) | `\s` | N/A | N/A | `\s` | `\s` |
| 匹配非单词数字 | `\W` | `\W` | `\W` | `\W` | `\W` |
...
| 匹配`\` | `\\` | `\\` | `\\` | `\\` | `\\` |
| 匹配控制字符x<sup id="a6">[6]](#f6) | `\cx` | N/A | N/A | N/A | `\cx` |
| 匹配十六进制n, n为2位数字<sup id="a7">[7](#f7) | `\xn` | N/A | N/A | N/A | `\xn` |
| 匹配引用 | `\num` | N/A | `\num` | `\num` | N/A |
...
| 匹配可见字符<sup id="a8">[8](#f8) | `[:graph:]` | `[:graph:]` | `[:graph:]` | `[:graph:]` | `[:graph:]` |
| 匹配可打印字符<sup id="a9">[9](#f9) | `[:print:]` | `[:print:]` | `[:print:]` | `[:print:]` | `[:print:]` |
| 匹配控制字符 | `[:cntrl:]` | `[:cntrl:]` | `[:cntrl:]` | `[:cntrl:]` | `[:cntrl:]` |
| 匹配标点符号<sup id="a10">[10](#f10) | `[:punct:]` | `[:punct:]` | `[:punct:]` | `[:punct:]` | `[:punct:]` |
